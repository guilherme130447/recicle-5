...
urlpatterns = [
    path("coletor/novo", views.RegistroColetor.as_view(), name="coletor_registro"),
    path("coletor/editar", views.EditarColetor.as_view(), name="coletor_edicao"),
    path(
        "consumidor/novo",
    ...
    path(
        "consumidor/editar", views.EditarConsumidor.as_view(), name="consumidor_edicao"
    ),
]
...
urlpatterns += [
    ...
    path(
        "alterar-senha/",
        views.UsuarioPasswordChangeView.as_view(),
        name="password_change",
    ),
    path(
        "alterar-senha/sucesso/",
        views.UsuarioPasswordChangeDoneView.as_view(),
